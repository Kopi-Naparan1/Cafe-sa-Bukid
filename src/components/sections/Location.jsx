...
export default function Location() {
  return (
    <Section className="grid min-h-[70vh] gap-10 w-full rounded-2xl shadow-[0_4px_12px_2px_rgba(0,0,0,0.3)] bg-secondary-light/30 overflow-hidden md:grid-cols-5 md:items-center">
      {/* MAP */}
